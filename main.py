...
from core_siege.ui import GameHud, GameWidget
...
class GameScreen(QtWidgets.QWidget):
    ...
    def __init__(self, level: Level, parent: QtWidgets.QWidget | None = None) -> None:
        ...
        self.hud = GameHud(self.game_state)

        layout = QtWidgets.QHBoxLayout(self)
        layout.addWidget(self.scene)
        layout.addWidget(self.hud)

        self.scene.tower_selected.connect(self.hud.set_selected_tower)
        self.hud.tower_changed.connect(self.on_tower_changed)
        self.hud.pause_clicked.connect(self.game_state.toggle_pause)
