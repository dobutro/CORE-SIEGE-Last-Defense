...
def build_levels(cell_size: int) -> List[Level]:
    ...
    desert_path = [(0, 4), (11, 4)]
    maze_path = [(0, 2), (4, 2), (4, 7), (8, 7), (8, 3), (11, 3)]
    city_path = [(0, 2), (5, 2), (5, 6), (11, 6)]
    return [
        Level("Пустыня", 12, 9, cell_size, desert_path),
        Level("Лабиринт", 12, 9, cell_size, maze_path),
        Level("Город", 12, 9, cell_size, city_path),
    ]
